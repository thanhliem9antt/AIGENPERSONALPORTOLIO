...
import { Button, EmptyState, LoadingSpinner, Modal } from '../../components/common/UI';
...
export default function ProjectsPage(){
  const {data:items,setData:setItems,loading}=useResource('/projects');const [form,setForm]=useState(null);const [drag,setDrag]=useState(null);const fileRef=useRef();const {notify}=useToast();
