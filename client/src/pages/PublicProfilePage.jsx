...
export default function PublicProfilePage() {
  ...
  return (
    <main
      ...
      style={{ ...background, fontFamily: appearance.fontFamily }}
    >
      <div className="absolute inset-0 bg-black/30" />
      <motion.section
        {...animation}
        className="relative mx-auto w-full max-w-3xl border border-white/15 bg-black/40 p-5 shadow-2xl backdrop-blur-2xl sm:p-8"
        style={{
          borderRadius: appearance.borderRadius || 24,
          backdropFilter: `blur(${appearance.blurStrength || 18}px)`,
        }}
      >
